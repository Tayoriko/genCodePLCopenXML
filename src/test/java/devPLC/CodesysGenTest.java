...
class CodesysGenTest {
    ...
    void createXml() throws IOException {
        ...
        DeviceCreator deviceCreator = new DeviceCreator(new File(GData.DEFAULT_SOURCE), GData.getInstance().getDevices());
